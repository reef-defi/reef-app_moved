  ...
  <div className="no-extension">
    <header className="header">
      <div className="header__content">
        ...
        <div className='header__sub-content'>App uses browser extension to get accounts and securely sign transactions.<br/>Please install the extension and refresh the page.</div>
      </div>
