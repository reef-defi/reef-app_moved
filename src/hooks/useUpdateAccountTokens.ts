...
// This hook is used to retrieve account reef tokens even if the account address was not claimed
export const useUpdateAccountTokens = (provider?: Provider): void => {
