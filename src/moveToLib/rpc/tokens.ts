...
import { getTokenListPrices, getTokenPrice } from '../prices';
...
export const loadAccountTokens = async (signer: Signer, network: ReefNetwork): Promise<TokenWithAmount[]> => {
  // TODO remove
  const signerAddress = '0x4a944a2b85afe9851bea6c33941f8adb85469d41'; // await signer.getAddress();
  if (!development) {
    throw new Error('remove above');
  }
